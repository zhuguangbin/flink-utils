 ...
 */
public class ConfigurableFileSystemTableFactory implements DynamicTableSourceFactory, DynamicTableSinkFactory {

    public static final String IDENTIFIER = "filesystem-configurable";
    public static final ConfigOption<String> SINK_FILE_PATTERN_PREFIX = ConfigOptions.key("sink.file-pattern.prefix").stringType().defaultValue("part").withDescription("The default prefix of file name");
    public static final ConfigOption<String> SINK_FILE_PATTERN_SUFFIX = ConfigOptions.key("sink.file-pattern.suffix").stringType().defaultValue("").withDescription("The default suffix of file name");
    ...
    public Set<ConfigOption<?>> optionalOptions() {
        Set<ConfigOption<?>> options = new HashSet<>();
        options.add(SINK_FILE_PATTERN_PREFIX);
        options.add(SINK_FILE_PATTERN_SUFFIX);
