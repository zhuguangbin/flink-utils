 ...
 */
public class AvroConsumerRecordValueWrapper implements Serializable {
  ...
  public AvroConsumerRecordValueWrapper(String topic, int partition, long offset, long timestamp, Schema schema, byte[] value) {
    this.topic = topic;
