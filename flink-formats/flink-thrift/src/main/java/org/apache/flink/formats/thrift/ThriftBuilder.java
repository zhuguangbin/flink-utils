...
/**
 * A builder to create a {@link BinaryBlockWriter} from outputStream.
 *
 * @param <T> The type of elements written by the writer.
 */
@FunctionalInterface
public interface ThriftBuilder<T> extends Serializable {

	/**
	 * Creates and configures a parquet writer to the given output file.
	 */
	BinaryBlockWriter<T> createWriter(OutputStream outputStream) throws IOException;
}
